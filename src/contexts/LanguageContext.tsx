...
const translations = {
  pt: {
    ...
    'welcome.hero.title': 'Transparência em Projetos',
    'welcome.hero.subtitle': 'Visualize atividades e progresso de projetos em tempo real para clientes',
    'welcome.hero.description': 'Esta é uma aplicação independente criada para o solidtime, focada em proporcionar transparência total das atividades de projetos para clientes.',
    'welcome.features.title': 'Funcionalidades',
    'welcome.about.title': 'Sobre o Projeto',
    'welcome.about.description': 'Esta aplicação foi desenvolvida como uma iniciativa independente para trabalhar em conjunto com o solidtime, proporcionando uma interface dedicada à transparência de projetos.',
    'welcome.about.solidtime': 'O solidtime é uma ferramenta poderosa de controle de tempo, e esta aplicação complementa suas funcionalidades com foco na visualização para clientes.',
    'welcome.footer': 'Desenvolvido com ❤️ para transparência de projetos',
    'feature.transparency.title': 'Transparência Total',
    'feature.transparency.description': 'Visualização completa das atividades do projeto para clientes',
    'feature.timetracking.title': 'Controle de Tempo',
    'feature.timetracking.description': 'Acompanhamento detalhado do tempo gasto em cada tarefa',
    'feature.analytics.title': 'Análises Avançadas',
    'feature.analytics.description': 'Relatórios e gráficos detalhados sobre o progresso',
    'feature.clients.title': 'Foco no Cliente',
    'feature.clients.description': 'Interface pensada especialmente para a experiência do cliente',
    'feature.security.title': 'Segurança',
    'feature.security.description': 'Proteção de dados e acesso controlado aos projetos',
    'feature.realtime.title': 'Tempo Real',
    'feature.realtime.description': 'Atualizações instantâneas das atividades do projeto',
  ...
  en: {
    ...
    'welcome.hero.title': 'Project Transparency',
    'welcome.hero.subtitle': 'Visualize project activities and progress in real-time for clients',
    'welcome.hero.description': 'This is an independent application created for solidtime, focused on providing complete transparency of project activities for clients.',
    'welcome.features.title': 'Features',
    'welcome.about.title': 'About the Project',
    'welcome.about.description': 'This application was developed as an independent initiative to work together with solidtime, providing a dedicated interface for project transparency.',
    'welcome.about.solidtime': 'Solidtime is a powerful time tracking tool, and this application complements its features with a focus on client visualization.',
    'welcome.footer': 'Built with ❤️ for project transparency',
    'feature.transparency.title': 'Complete Transparency',
    'feature.transparency.description': 'Full visualization of project activities for clients',
    'feature.timetracking.title': 'Time Tracking',
    'feature.timetracking.description': 'Detailed tracking of time spent on each task',
    'feature.analytics.title': 'Advanced Analytics',
    'feature.analytics.description': 'Detailed reports and charts about progress',
    'feature.clients.title': 'Client Focus',
    'feature.clients.description': 'Interface designed especially for client experience',
    'feature.security.title': 'Security',
    'feature.security.description': 'Data protection and controlled access to projects',
    'feature.realtime.title': 'Real Time',
    'feature.realtime.description': 'Instant updates of project activities',
  ...
  es: {
    ...
    'welcome.hero.title': 'Transparencia de Proyectos',
    'welcome.hero.subtitle': 'Visualiza actividades y progreso de proyectos en tiempo real para clientes',
    'welcome.hero.description': 'Esta es una aplicación independiente creada para solidtime, enfocada en proporcionar transparencia completa de actividades de proyectos para clientes.',
    'welcome.features.title': 'Características',
    'welcome.about.title': 'Sobre el Proyecto',
    'welcome.about.description': 'Esta aplicación fue desarrollada como una iniciativa independiente para trabajar junto con solidtime, proporcionando una interfaz dedicada para la transparencia de proyectos.',
    'welcome.about.solidtime': 'Solidtime es una herramienta poderosa de seguimiento de tiempo, y esta aplicación complementa sus características con un enfoque en la visualización para clientes.',
    'welcome.footer': 'Construido con ❤️ para transparencia de proyectos',
    'feature.transparency.title': 'Transparencia Completa',
    'feature.transparency.description': 'Visualización completa de actividades del proyecto para clientes',
    'feature.timetracking.title': 'Seguimiento de Tiempo',
    'feature.timetracking.description': 'Seguimiento detallado del tiempo dedicado a cada tarea',
    'feature.analytics.title': 'Análisis Avanzados',
    'feature.analytics.description': 'Informes detallados y gráficos sobre el progreso',
    'feature.clients.title': 'Enfoque en el Cliente',
    'feature.clients.description': 'Interfaz diseñada especialmente para la experiencia del cliente',
    'feature.security.title': 'Seguridad',
    'feature.security.description': 'Protección de datos y acceso controlado a proyectos',
    'feature.realtime.title': 'Tiempo Real',
    'feature.realtime.description': 'Actualizaciones instantáneas de actividades del proyecto',
  ...
  fr: {
    ...
    'welcome.hero.title': 'Transparence des Projets',
    'welcome.hero.subtitle': 'Visualisez les activités et le progrès des projets en temps réel pour les clients',
    'welcome.hero.description': 'Ceci est une application indépendante créée pour solidtime, axée sur la fourniture d\'une transparence complète des activités de projet pour les clients.',
    'welcome.features.title': 'Fonctionnalités',
    'welcome.about.title': 'À Propos du Projet',
    'welcome.about.description': 'Cette application a été développée comme une initiative indépendante pour travailler avec solidtime, fournissant une interface dédiée pour la transparence des projets.',
    'welcome.about.solidtime': 'Solidtime est un outil puissant de suivi du temps, et cette application complète ses fonctionnalités en se concentrant sur la visualisation pour les clients.',
    'welcome.footer': 'Construit avec ❤️ pour la transparence des projets',
    'feature.transparency.title': 'Transparence Complète',
    'feature.transparency.description': 'Visualisation complète des activités du projet pour les clients',
    'feature.timetracking.title': 'Suivi du Temps',
    'feature.timetracking.description': 'Suivi détaillé du temps passé sur chaque tâche',
    'feature.analytics.title': 'Analyses Avancées',
    'feature.analytics.description': 'Rapports détaillés et graphiques sur les progrès',
    'feature.clients.title': 'Focus Client',
    'feature.clients.description': 'Interface conçue spécialement pour l\'expérience client',
    'feature.security.title': 'Sécurité',
    'feature.security.description': 'Protection des données et accès contrôlé aux projets',
    'feature.realtime.title': 'Temps Réel',
    'feature.realtime.description': 'Mises à jour instantanées des activités du projet',
  ...
  de: {
    ...
    'welcome.hero.title': 'Projekt-Transparenz',
    'welcome.hero.subtitle': 'Visualisieren Sie Projektaktivitäten und Fortschritt in Echtzeit für Kunden',
    'welcome.hero.description': 'Dies ist eine unabhängige Anwendung für solidtime, die sich darauf konzentriert, vollständige Transparenz der Projektaktivitäten für Kunden zu bieten.',
    'welcome.features.title': 'Funktionen',
    'welcome.about.title': 'Über das Projekt',
    'welcome.about.description': 'Diese Anwendung wurde als unabhängige Initiative entwickelt, um mit solidtime zusammenzuarbeiten und eine dedizierte Schnittstelle für Projekt-Transparenz zu bieten.',
    'welcome.about.solidtime': 'Solidtime ist ein leistungsstarkes Zeiterfassungstool, und diese Anwendung ergänzt seine Funktionen mit Fokus auf Kundenvisualisierung.',
    'welcome.footer': 'Mit ❤️ für Projekt-Transparenz entwickelt',
    'feature.transparency.title': 'Vollständige Transparenz',
    'feature.transparency.description': 'Vollständige Visualisierung der Projektaktivitäten für Kunden',
    'feature.timetracking.title': 'Zeiterfassung',
    'feature.timetracking.description': 'Detaillierte Verfolgung der für jede Aufgabe aufgewendeten Zeit',
    'feature.analytics.title': 'Erweiterte Analysen',
    'feature.analytics.description': 'Detaillierte Berichte und Diagramme über den Fortschritt',
    'feature.clients.title': 'Kundenfokus',
    'feature.clients.description': 'Schnittstelle speziell für die Kundenerfahrung entwickelt',
    'feature.security.title': 'Sicherheit',
    'feature.security.description': 'Datenschutz und kontrollierter Zugang zu Projekten',
    'feature.realtime.title': 'Echtzeit',
    'feature.realtime.description': 'Sofortige Updates der Projektaktivitäten',
  ...
  ru: {
    ...
    'welcome.hero.title': 'Прозрачность Проектов',
    'welcome.hero.subtitle': 'Визуализируйте активности и прогресс проектов в реальном времени для клиентов',
    'welcome.hero.description': 'Это независимое приложение, созданное для solidtime, ориентированное на обеспечение полной прозрачности проектных активностей для клиентов.',
    'welcome.features.title': 'Функции',
    'welcome.about.title': 'О Проекте',
    'welcome.about.description': 'Это приложение было разработано как независимая инициатива для работы с solidtime, предоставляя специализированный интерфейс для прозрачности проектов.',
    'welcome.about.solidtime': 'Solidtime - это мощный инструмент учета времени, и это приложение дополняет его функции с акцентом на визуализацию для клиентов.',
    'welcome.footer': 'Создано с ❤️ для прозрачности проектов',
    'feature.transparency.title': 'Полная Прозрачность',
    'feature.transparency.description': 'Полная визуализация проектных активностей для клиентов',
    'feature.timetracking.title': 'Учет Времени',
    'feature.timetracking.description': 'Детальное отслеживание времени, затраченного на каждую задачу',
    'feature.analytics.title': 'Расширенная Аналитика',
    'feature.analytics.description': 'Подробные отчеты и графики о прогрессе',
    'feature.clients.title': 'Фокус на Клиента',
    'feature.clients.description': 'Интерфейс, разработанный специально для клиентского опыта',
    'feature.security.title': 'Безопасность',
    'feature.security.description': 'Защита данных и контролируемый доступ к проектам',
    'feature.realtime.title': 'Реальное Время',
    'feature.realtime.description': 'Мгновенные обновления проектных активностей',
  ...
  zh: {
    ...
    'welcome.hero.title': '项目透明度',
    'welcome.hero.subtitle': '为客户实时可视化项目活动和进度',
    'welcome.hero.description': '这是为solidtime创建的独立应用程序，专注于为客户提供项目活动的完全透明度。',
    'welcome.features.title': '功能特性',
    'welcome.about.title': '关于项目',
    'welcome.about.description': '这个应用程序是作为独立倡议开发的，与solidtime合作，为项目透明度提供专用界面。',
    'welcome.about.solidtime': 'Solidtime是一个强大的时间跟踪工具，这个应用程序补充了其功能，专注于客户可视化。',
    'welcome.footer': '用❤️为项目透明度而构建',
    'feature.transparency.title': '完全透明',
    'feature.transparency.description': '为客户完整可视化项目活动',
    'feature.timetracking.title': '时间跟踪',
    'feature.timetracking.description': '详细跟踪每个任务花费的时间',
    'feature.analytics.title': '高级分析',
    'feature.analytics.description': '关于进度的详细报告和图表',
    'feature.clients.title': '客户专注',
    'feature.clients.description': '专为客户体验设计的界面',
    'feature.security.title': '安全性',
    'feature.security.description': '数据保护和受控的项目访问',
    'feature.realtime.title': '实时',
    'feature.realtime.description': '项目活动的即时更新',
